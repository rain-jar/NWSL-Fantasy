...
# Base URL for Gotham team stats
TEAM_URL = "https://fbref.com/en/squads/8e306dc6/Gotham-FC-Stats"
...
for index, match_url in enumerate(match_links[:1]):  # Limit to first 5 matches for testing
    ...
    gk_stats_header = soup.find("h2", string="Gotham Goalkeeper Stats")
    ...
    player_stats_header = soup.find("h2", string="Gotham Player Stats")
...
if player_data:
    ...
    df.to_csv("Gotham_match_logs.csv", index=False)
    print("✅ Data saved to Gotham_match_logs.csv")
else:
