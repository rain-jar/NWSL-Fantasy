...
# Base URL for Pride team stats
TEAM_URL = "https://fbref.com/en/squads/2a6178ac/Orlando-Pride-Stats"
...
for index, match_url in enumerate(match_links[:1]):  # Limit to first match for testing
    ...
    gk_stats_header = soup.find("h2", string="Pride Goalkeeper Stats")
    ...
    player_stats_header = soup.find("h2", string="Pride Player Stats")
...
if player_data:
    ...
    df.to_csv("Pride_match_logs.csv", index=False)
    print("✅ Data saved to Pride_match_logs.csv")
else:
